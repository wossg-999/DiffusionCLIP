...
import sys
sys.path.append(r'D:\gitku\AD Codes\AdaCLIP')
...
def train(args):
    ...
    model = AdaCLIP_Trainer(
        ...
        use_sd_feature=args.use_sd_feature,
        sd_config_path=args.sd_config_path,
        sd_ckpt_path=args.sd_ckpt_path,
        sd_vae_ckpt_path=args.sd_vae_ckpt_path,
        sd_timestep=args.sd_timestep,
        sd_base_size=args.sd_base_size,
        sd_use_attention=args.sd_use_attention
    ).to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--use_sd_feature", type=str2bool, default=True,
                        help="Enable stable diffusion feature-level fusion in ViT blocks")
    parser.add_argument("--sd_config_path", type=str, default='method/v1-inference.yaml',
                        help="Stable diffusion config path")
    parser.add_argument("--sd_ckpt_path", type=str, default='',
                        help="Stable diffusion full checkpoint path (UNet + optional VAE)")
    parser.add_argument("--sd_vae_ckpt_path", type=str, default='',
                        help="Optional standalone VAE checkpoint path for real latent extraction")
    parser.add_argument("--sd_timestep", type=int, default=50,
                        help="Stable diffusion timestep for feature extraction")
    parser.add_argument("--sd_base_size", type=int, default=512,
                        help="Stable diffusion base size used by UNetWrapper")
    parser.add_argument("--sd_use_attention", type=str2bool, default=True,
                        help="Use SD attention maps in UNetWrapper outputs")
