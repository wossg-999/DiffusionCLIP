...
from .covid import COVID_CLS_NAMES, CovidDataset, COVID_ROOT
from .kvasir import KVASIR_CLS_NAMES, kvasirDataset, KVASIR_ROOT
from .uni_medical import UNI_MEDICAL_CLS_NAMES, uni_medical_Dataset, UNI_MEDICAL_ROOT
from .endo import ENDO_CLS_NAMES, endoDataset, ENDO_ROOT
from .brain import BRAIN_CLS_NAMES, BrainDataset, Brain_ROOT
from .liver import LIVER_CLS_NAMES, liverDataset, Liver_ROOT
from .retinal import retinal_CLS_NAMES, retinalDataset, retinal_ROOT
from .Camelyon16 import Camelyon16_CLS_NAMES, Camelyon16Dataset, Camelyon16_ROOT
from .BraTS2021 import BraTS2021_CLS_NAMES, BraTS2021Dataset, BraTS2021_ROOT
...
dataset_dict = {
    ...
    'covid': (COVID_CLS_NAMES, CovidDataset, COVID_ROOT),
    'kvasir': (KVASIR_CLS_NAMES, kvasirDataset, KVASIR_ROOT),
    'uni_medical': (UNI_MEDICAL_CLS_NAMES, uni_medical_Dataset, UNI_MEDICAL_ROOT),
    'endo': (ENDO_CLS_NAMES, endoDataset, ENDO_ROOT),
    'brain': (BRAIN_CLS_NAMES, BrainDataset, Brain_ROOT),
    'liver': (LIVER_CLS_NAMES, liverDataset, Liver_ROOT),
    'retinal': (retinal_CLS_NAMES, retinalDataset, retinal_ROOT),
    'camelyon16': (Camelyon16_CLS_NAMES, Camelyon16Dataset, Camelyon16_ROOT),
    'braTS2021': (BraTS2021_CLS_NAMES, BraTS2021Dataset, BraTS2021_ROOT),
}
