...
class AdaCLIP_Trainer(nn.Module):
    def __init__(
            ...
            use_sd_feature=False, sd_config_path='method/v1-inference.yaml',
            sd_ckpt_path='', sd_vae_ckpt_path='', sd_timestep=50, sd_base_size=512,
